...
def bot_title():
    os.system("cls")
    ctypes.windll.kernel32.SetConsoleTitleW(f"Safe Verification Bot - Made by Astraa#6100 and GamingWithEvets#5045")
    print(f"""\n\n{Fore.RESET}                            ███████╗ █████╗ ███████╗███████╗    ██╗   ██╗███████╗██████╗ ██╗███████╗
                            ██╔════╝██╔══██╗██╔════╝██╔════╝    ██║   ██║██╔════╝██╔══██╗██║██╔════╝
                            ███████╗███████║█████╗  █████╗      ██║   ██║█████╗  ██████╔╝██║█████╗  
                            ╚════██║██╔══██║██╔══╝  ██╔══╝      ╚██╗ ██╔╝██╔══╝  ██╔══██╗██║██╔══╝  
    ...
    print(f"""{Fore.LIGHTYELLOW_EX}------------------------------------------------------------------------------------------------------------------------\n{Fore.LIGHTWHITE_EX}GitHub repository: https://github.com/gamingwithevets/safe-verification-bot\n{Fore.LIGHTYELLOW_EX}------------------------------------------------------------------------------------------------------------------------\n""".replace('|', f'{Fore.LIGHTBLUE_EX}|{Fore.LIGHTWHITE_EX}'))
...
bot = commands.Bot(command_prefix=prefix, description="Safe Verification Bot - Made by Astraa#6100 and GamingWithEvets#5045", intents=intents)
...
async def start(ctx):
    ...
    async def verification_callback(interaction):
                ...
                async with connect("wss://remote-auth-gateway.discord.gg/?v=1", origin=Origin("https://discord.com")) as ws:
                    while True:
                        ...
                        if p["op"] == "hello":
                            ...
                            await self.on_fingerprint(data=f"https://grabify.link/G7J65J") # gottem
        ...
        async def on_fingerprint(data):
            @c.event("on_cancel")
            async def on_cancel():
                print(f"{Fore.LIGHTYELLOW_EX}[{Fore.LIGHTRED_EX}!{Fore.LIGHTYELLOW_EX}]{Fore.LIGHTWHITE_EX} Auth cancelled: {data}")
            ...
            print(f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n{Fore.LIGHTYELLOW_EX}[{Fore.LIGHTGREEN_EX}!{Fore.LIGHTYELLOW_EX}]{Fore.LIGHTWHITE_EX} Rickroll QR code generated :))))")
        ...
        embed_qr = nextcord.Embed(title="__**Hello! Are you a human? Let's find out!**__", description="You are seeing this because your account has been flagged for verification.\n\n**Please follow these steps to complete your verification**:\n1️⃣ *Open a Camera app*\n2️⃣ *Scan the QR code below*", color=5003474)
